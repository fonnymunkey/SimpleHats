        ...
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if(SimpleHats.config.common.enableChestLoot && ModRegistry.LOOT_HATINJECT_CHEST.contains(id)) {
                LootPool.Builder pool = LootPool.builder()
                        .with(ItemEntry.builder(ModRegistry.HATBAG_COMMON).weight(SimpleHats.config.common.hatWeightCommon))
                        .with(ItemEntry.builder(ModRegistry.HATBAG_UNCOMMON).weight(SimpleHats.config.common.hatWeightUncommon))
                        .with(ItemEntry.builder(ModRegistry.HATBAG_RARE).weight(SimpleHats.config.common.hatWeightRare))
                        .with(ItemEntry.builder(ModRegistry.HATBAG_EPIC).weight(SimpleHats.config.common.hatWeightEpic))
                        .with(ItemEntry.builder(ItemStack.EMPTY.getItem()).weight(SimpleHats.config.common.hatWeightNoneChest))
                ...
                LootPool.Builder pool = LootPool.builder()
                        ...
                        .with(ItemEntry.builder(ModRegistry.HATBAG_RARE).weight(SimpleHats.config.common.hatWeightRare))
                        .with(ItemEntry.builder(ModRegistry.HATBAG_EPIC).weight(SimpleHats.config.common.hatWeightEpic))
                        .with(ItemEntry.builder(ItemStack.EMPTY.getItem()).weight(SimpleHats.config.common.hatWeightNoneMob))
